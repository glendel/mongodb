...
Download and install {Ruby 1.9.2}[http://www.ruby-lang.org/en/downloads/], the {MongoDB 1.6.5}[http://www.mongodb.org/downloads] and install the latest gems needed using the {bundle}[https://github.com/carlhuda/bundler] command :
